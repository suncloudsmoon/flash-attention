...
sudo apt install cuda cuda-nvcc-12-1 cuda-libraries-dev-12-1
sudo apt clean

rm -f https://developer.download.nvidia.com/compute/cuda/12.1.1/local_installers/cuda-repo-${OS}-12-1-local_12.1.1-530.30.02-1_amd64.deb
